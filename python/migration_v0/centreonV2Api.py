...
def getHostGroups(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getHostGroups() ending')
    return(body)
...
def getHostCategories(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getHostCategories() ending')
    return(body)
...
def getHostSeverities(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getHostSeverities() ending')
    return(body)
...
def getHostTemplates(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getHostTemplates() ending')
    return(body)
...
def getServiceGroups(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getServiceGroup() ending')
    return(body)
...
def getServiceCategories(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getServiceCategorie() ending')
    return(body)
...
def getServiceSeverities(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    ...
    logging.debug('getServiceSeveritie() ending')
    return(body)

def getServiceTemplates(serverAddress: str, authToken: str, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('getServiceTemplates() starting')
    body = getGeneric(serverAddress, '/configuration/services/templates', authToken=authToken)
    logging.debug('getServiceTemplates() ending')
    return(body)
...
def createHostGroup(serverAddress: str, jsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('createHostGroup() starting')
    body = createGeneric(serverAddress, '/configuration/hosts/groups', authToken, jsonData)
    logging.debug('createHostGroup() ending')
    return(body)

def createHostCategory(serverAddress: str, jsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('createHostCategory() starting')
    body = createGeneric(serverAddress, '/configuration/hosts/categories', authToken, jsonData)
    logging.debug('createHostCategory() ending')
    return(body)

def createHostSeverity(serverAddress: str, jsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('createHostSeverity() starting')
    body = createGeneric(serverAddress, '/configuration/hosts/severities', authToken, jsonData)
    logging.debug('createHostSeverity() ending')
    return(body)

def createServiceGroup(serverAddress: str, jsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('createServiceGroup() starting')
    body = createGeneric(serverAddress, '/configuration/services/groups', authToken, jsonData)
    logging.debug('createServiceGroup() ending')
    return(body)

def createServiceCategory(serverAddress: str, jsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('createServiceCategory() starting')
    body = createGeneric(serverAddress, '/configuration/services/categories', authToken, jsonData)
    logging.debug('createServiceCategory() ending')
    return(body)

def createServiceSeverity(serverAddress: str, jsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('createServiceSeverity() starting')
    body = createGeneric(serverAddress, '/configuration/services/severities', authToken, jsonData)
    logging.debug('createServiceSeverity() ending')
    return(body)
...
def deleteServiceTemplate(serverAddress: str, idToDelete: int, authToken, customUri: str = "centreon", serverProto: str = "http"):
    logging.debug('deleteServiceTemplate() starting - deleting host template ' + str(idToDelete))
