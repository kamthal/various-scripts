...
def cv2api_createHostGroup(serverAddress: str, hgJsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    return cv2api_createGeneric('192.168.59.134', '/configuration/hosts/groups', authToken, hgJsonData)

def cv2api_createHostCategory(serverAddress: str, hgJsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    return cv2api_createGeneric('192.168.59.134', '/configuration/hosts/categories', authToken, hgJsonData)

def cv2api_createHostSeverity(serverAddress: str, hgJsonData, authToken, customUri: str = "centreon", serverProto: str = "http"):
    return cv2api_createGeneric('192.168.59.134', '/configuration/hosts/categories', authToken, hgJsonData)
